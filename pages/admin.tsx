...
import { LastChecked, PriceHistoryLimit, Store } from "../utilities/utilities";
...
const AdminPanel = ({ lastChecked }: Props) => {
  ...
  useEffect(() => {
    (async () => {
      setLoadState("isLoading");
      const dbProducts = await DBFetchAllAPI(
        20,
        Store.Any,
        PriceHistoryLimit.Any
      );
      ...
      <div className="content-body">
        ...
        <div className="central-responsive-div min-h-[50rem]">
            ...
            <ul>
              <li>
                <Link
                  ...
                  href="/test-features/multi-store-products"
                >
          ...
          <div className="text-center pt-4 pb-1 text-zinc-800 dark:text-zinc-300">
            ...
            {loadState === "hasSearched" &&
              maxProductsToSearch === products.length && (
                <span>
                  {products.length}+ results found for {startCase(searchQuery)}
                </span>
              )}
