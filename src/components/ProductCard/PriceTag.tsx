...
import { getPriceAvgDifference } from "@/lib/utils";
...
function printDollars(price: number | undefined) {
  if (price === null || price === undefined) return "XX";
  else if (price.toString().includes(".")) {
    return price.toString().split(".")[0];
  } else return price.toString();
}

function printCents(price: number | undefined) {
  if (price === null || price === undefined) return "XX";
  else if (price.toString().includes(".")) {
